...
def load_acm(ratio, type_num):
    ...
    path = "/home/yhkj/D/MHGCN/HeCo/data/acm/"
...
def load_dblp(ratio, type_num):
    ...
    path = "/home/yhkj/D/MHGCN/HeCo/data/dblp/"
    label = np.load(path + "labels.npy").astype('int32')
    label = encode_onehot(label)
...
def load_aminer(ratio, type_num):
    ...
    path = "/home/yhkj/D/MHGCN/HeCo/data/aminer/"
    label = np.load(path + "labels.npy").astype('int32')
    label = encode_onehot(label)
    nei_a = np.load(path + "nei_a.npy", allow_pickle=True)
...
def load_freebase(ratio, type_num):
    ...
    path = "/home/yhkj/D/MHGCN/HeCo/data/freebase/"
    label = np.load(path + "labels.npy").astype('int32')
    label = encode_onehot(label)
...
data = load_dblp([20,40,60], [4057, 14328, 7723, 20])
